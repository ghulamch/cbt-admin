                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
    <h2 class="text-white pb-2 fw-bold">Daftar Peserta Ruang - 03</h2>
...
<div class="ml-md-auto py-2 py-md-0">
    ...
    Swal.fire({
        ...
        icon: 'info',
        text: "Anda sedang berada di Ruang 03, silakan pilih mata pelajaran!"
    });
</script>
<div class="row">
    <div class="col-12">
...
$s_ruang = "RUANG 03"; // Nilai statis yang diinginkan
    ...
    <script>
        $(document).ready(function(){
            ...
            function reloadTable() {
                $.ajax({
                    url: 'load_data_3.php', // Ubah URL sesuai dengan lokasi skrip PHP Anda
                    type: 'POST',
